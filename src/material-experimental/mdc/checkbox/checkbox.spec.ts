...
import {MatCheckbox, MatCheckboxChange, MatCheckboxModule, MAT_CHECKBOX_CLICK_ACTION} from './index';
import {MutationObserverFactory} from '@angular/cdk/observers';


fdescribe('MatCheckbox', () => {
  ...
  describe('basic behaviors', () => {
    ...
    // Commented out because it uses _onInputClick which is not part of the public API.
